...
**Implementation**:
- RLCF Core: `merlt/rlcf_framework/main.py`, `routers/`
- Orchestration API: `merlt/orchestration/api/main.py`, `routers/`
- Middleware: `merlt/orchestration/api/middleware/auth.py`, `rate_limit.py`
