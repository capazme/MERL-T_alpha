...
2. **Redis Caching Layer** (4 hours)
   ```python
   # File: merlt/orchestration/api/services/cache_service.py
...
3. **Update API Services** (6 hours)
   ```python
   # Modify: merlt/orchestration/api/services/query_executor.py
...
- `merlt/orchestration/api/database.py` (150 LOC) - SQLAlchemy models
- `merlt/orchestration/api/models.py` (200 LOC) - Database models
- `merlt/orchestration/api/services/persistence_service.py` (300 LOC) - CRUD operations
- `merlt/orchestration/api/services/cache_service.py` (200 LOC) - Redis caching
...
```python
# merlt/orchestration/api/services/query_executor.py:82-88
...
# merlt/orchestration/langgraph_workflow.py:108-278 (preprocessing_node)
...
**Files to Modify**:
- `merlt/orchestration/api/services/query_executor.py` (+180 LOC)
- `merlt/orchestration/langgraph_workflow.py` (update preprocessing node)
...
2. **Implement Auth Middleware** (4 hours)
   ```python
   # File: merlt/orchestration/api/middleware/auth.py
   ...
   ```python
   # File: merlt/orchestration/api/middleware/rate_limit.py
...
3. **Apply Middleware** (2 hours)
   ```python
   # Modify: merlt/orchestration/api/main.py
...
- `merlt/orchestration/api/middleware/auth.py` (150 LOC)
- `merlt/orchestration/api/middleware/rate_limit.py` (100 LOC)
