...
from .sys_op import web_driver_manager
...
def generate_urn(act_type, date=None, act_number=None, article=None, annex=None, version=None, version_date=None, urn_flag=True):
    ...
    if normalized_act_type.lower() in EURLEX:
        ...
        if EurlexScraper is None:
            try:
                from backend.external_sources.visualex.scrapers.eurlex_scraper import EurlexScraper as _EurlexScraper
                EurlexScraper = _EurlexScraper
            except ImportError:
                from ..scrapers.eurlex_scraper import EurlexScraper as _EurlexScraper
                EurlexScraper = _EurlexScraper
